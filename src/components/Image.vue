...
<template>
  <aside class="flex flex-col text-white h-full">
    ...
    <div class="flex text-sm flex-col mt-2 mx-auto space-y-2">
      ...
      <button
        v-if="loggedUser"
        class="px-2 rounded md:text-xl"
        @click="signOutUser"
      >
        Sign Out
      </button>
    </div>
    <div class="md:ml-1 text-xs w-full flex flex-col space-y-2">
      ...
      <div class="flex flex-col md:flex-row md:space-x-2 items-center">
        ...
        <p class="md:text-base h-auto text-center whitespace-pre-wrap">
          {{ data.texts.address }}
        </p>
      </div>
      <div class="flex flex-col md:flex-row md:space-x-2 items-center">
        ...
        <a
          class="break-all h-auto md:text-base"
      ...
      >
        ...
        <a class="md:text-base" :href="`mailto:${data.texts.email2}`">{{
          data.texts.email2
        }}</a>
      </div>
      <div class="flex flex-col md:flex-row md:space-x-2 items-center">
        ...
        <a :href="`tel:${data.texts.tel}`" class="md:text-base">{{
          data.texts.tel
        }}</a>
      </div>
      <div
